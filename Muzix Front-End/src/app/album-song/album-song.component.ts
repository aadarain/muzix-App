...
export class AlbumSongComponent implements OnInit {
  ...
  testsearch:boolean;
    ...
    openDialog() {
      ...
      this.recsong.trackName=addtofav.trackName;
      this.recsong.trackId=addtofav.trackId;
      this.recsong.artistName=addtofav.artistName;
      this.recsong.albumName=addtofav.collectionName;
      this.recsong.trackurl=addtofav.previewUrl;
      this.recsong.trackGenre=addtofav.primaryGenreName;
      ...
      if(this.recflag==0)
      {
        ...
        this.counterrec.forEach(element => {
          ...
          if(element.trackId==addtofav.trackId){
            ...
            this.recommendcount.trackName=addtofav.trackName;
            this.recommendcount.trackId=addtofav.trackId;
            this.recommendcount.artistName=addtofav.artistName;
            this.recommendcount.albumName=addtofav.collectionName;
            this.recommendcount.trackurl=addtofav.previewUrl;
            this.recommendcount.trackGenre=addtofav.primaryGenreName;
    ...
    removefromfav(trackId:String){
      this.songservice.removefromfavourite(trackId).subscribe(
        data=>{
      ...
      this.sharedservice.setdialogtitle("Removed");
      this.sharedservice.setdialogcontent("Removed from Favourite list");
      this.openaddDialog();
      this.ngOnInit();
