...
export class SongService {
  ...
  updateUser(updateUser: updateuser): Observable<updateuser> {
    ...
    return this.httpclient.put<updateuser>('http://localhost:8282/update',updateUser);
  ...
  removefromfavourite(id :String):Observable<any>{
    return this.httpclient.delete<any>("http://localhost:8080/favourites/removefromfav/"+id);
  }
